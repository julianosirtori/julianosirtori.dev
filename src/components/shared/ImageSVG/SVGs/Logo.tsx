export const Logo = ({ ...props }: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="53" height="53" viewBox="0 0 53 53" fill="none" {...props}>
      <mask id="path-1-inside-1_64_1296" fill="white">
        <path fillRule="evenodd" clip-rule="evenodd" d="M0 14H13H26V27H13V40H26V53H13H0V40V27V14Z" />
      </mask>
      <path
        ...
        fill="#C778DD" mask="url(#path-1-inside-1_64_1296)" />
      <mask id="path-3-outside-2_64_1296" maskUnits="userSpaceOnUse" x="25" y="0" width="28" height="41" fill="black">
        ...
        <path fillRule="evenodd" clip-rule="evenodd" d="M26 1H39H52V14V27V40H39H26V27H39V14H26V1Z" />
      </mask>
      <path
        ...
        fill="#C778DD" mask="url(#path-3-outside-2_64_1296)" />
    </svg>
  )
}