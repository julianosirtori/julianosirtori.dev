...
export const Presentation = () => {
  return (
    <section className="flex flex-col gap-6 p-4 mt-5 w-full pb-11">
      <div className="w-full flex flex-col gap-6">
        <h1 className="font-semibold text-2xl text-white max-w-sm">Juliano is a <span className="text-primary">front-end web developer</span></h1>
        <p className="text-gray ">He crafts responsive websites where technologies meet creativity</p>
      </div>
      <div className="flex w-full flex-col items-center">
        <div className="relative w-full h-72 max-w-sm">
        ...
        <div className="border border-gray p-2 flex flex-row gap-2 w-full">
          ...
          <div className="flex flex-col">
            <span className="text-gray font-semibold">Currently working on</span>
            <span className="text-white font-bold">Currently working Portfolio</span>
          </div>
        </div>
      </div>
